...
$ python cs285/scripts/run_hw1_behavior_cloning.py --expert_policy_file cs285/policies/experts/RoboschoolAnt-v1.py --env_name RoboschoolAnt-v1 --exp_name test_bc_ant --n_iter 10 --expert_data cs285/expert_data/RoboschoolAnt-v1.pkl --do_dagger --video_log_freq -1
